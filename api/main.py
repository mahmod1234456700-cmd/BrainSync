...
def get_gemini_url():
    ...
    # التعديل الجذري: استخدام gemini-1.5-pro للعمل بدون أخطاء
    return f"https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent?key={key}"
