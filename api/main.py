...
def analyze():
    ...
    try:
        ...
        # هندسة البرومبت الصارم لفرض أعداد الأسئلة (20-60) وتوزيع الصعوبة (10 سهل، 10 متوسط، والباقي معقد)
        ...
        prompt += "1. قسم الاختيار من متعدد (MCQ): يجب استخراج من 20 إلى 60 سؤالاً. التوزيع الإجباري للصعوبة داخل هذا القسم: أول 10 أسئلة (سهلة)، ثم 10 أسئلة (متوسطة)، ثم بقية الأسئلة (معقدة وتتطلب تفكيراً علياً). كل سؤال يحتوي على 4 اختيارات في options، والإجابة الصحيحة في a، والشرح العلمي الوافي والتفصيلي في reason.\n"
        prompt += "2. قسم الصح والخطأ (TF): يجب استخراج من 20 إلى 60 سؤالاً. التوزيع الإجباري للصعوبة داخل هذا القسم: أول 10 أسئلة (سهلة)، ثم 10 أسئلة (متوسطة)، ثم بقية الأسئلة (معقدة). كتابة العبارة في q، والحكم عليها (صحيحة / خطأ) في a، والتفسير العلمي الوافي والتفصيلي لسبب الصح أو الخطأ في reason.\n"
        prompt += "3. قسم الأسئلة المقالية (Essay): يجب استخراج من 20 إلى 60 سؤالاً. التوزيع الإجباري للصعوبة داخل هذا القسم: أول 10 أسئلة (سهلة)، ثم 10 أسئلة (متوسطة)، ثم بقية الأسئلة (معقدة). تقديم إجابة نموذجية وافية ومفصلة جداً تناسب امتحانات الثانوية العامة في a، وشرح إضافي وافٍ في reason.\n"
        prompt += "4. الحد الأدنى الإجمالي للأسئلة في الملف هو 60 سؤالاً على الأقل (20 لكل قسم)، والحد الأقصى 180 سؤالاً (60 لكل قسم). إياك أن تختصر أو تقدم عدداً أقل.\n"
