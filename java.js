...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================================================
    // 7. إرسال الطلب للسيرفر والتلخيص (بدون كاش لتوليد فعلي من 20 إلى 50 سؤال)
    // ============================================================================
    const processBtn = document.getElementById('process-btn');
    ...
    // ============================================================================
    // 8. عرض المخرجات وتوليد ملف PDF شامل (بدون كلمة "مقالي" + صح وخطأ بقوسين ✓ و ✕)
    // ============================================================================
    ...
    function generateRealPDF(serverData, subjectName) {
        ...
        serverData.qa_data.forEach((item, index) => {
            ...
            if (!isExamMode) {
                if (item.type === "TF") {
                    // عرض الحكم بقوسين مباشرين [ ✓ ] أو [ ✕ ] مع ذكر السبب العلمي الوافي
