...
document.addEventListener('DOMContentLoaded', () => {
    ...
    lessonImageInput.addEventListener('change', (event) => {
        if (event.target.files.length > 0) {
            ...
            // قراءة أول صورة فقط لعرضها في المعاينة المصغرة
    ...
    if (processBtn) {
        processBtn.addEventListener('click', async () => {
            ...
            // التعديل: فحص مصفوفة الصور بدلاً من صورة واحدة
            ...
            try {
                ...
                // الحفاظ على تقنية التخزين المؤقت لديك بتوليد هاش للصورة الأولى + عدد الصور
                ...
                if (needNewUploadAndAPI) {
                    ...
                    // ==========================================
                    // التعديل: نظام ضغط ومعالجة قائمة الصور معاً
                    // ==========================================
                    ...
                    // ==========================================
                    // الاتصال بسيرفر البايثون (إرسال المصفوفة الجديدة)
                    // ==========================================
                    const serverPayload = {
                        action: 'analyze',
                ...
                // ===============================================
                // التعديل: قراءة الشرح المبسط بصوت الروبوت مباشرة
                // ===============================================
    ...
    function showOutput(serverData, subjectName) {
        ...
        // عرض الشرح المبسط للدرس في قسم المخرجات
    ...
    function generateRealPDF(serverData) {
        ...
        // --- التعديل الجذري لحل مشكلة الشاشة البيضاء في الموبايل ---
        ...
        setTimeout(() => {
            html2pdf().set(opt).from(elementToPrint).save().then(() => {
                // إرجاع العنصر لحالته الطبيعية المخفية بعد التحميل
                elementToPrint.style.display = 'none';
                elementToPrint.style.position = 'static';
                elementToPrint.style.zIndex = 'auto';
