// ============================================================================
// ملف الجافاسكريبت الرئيسي (java.js) - مشروع إمبراطورية المعرفة (MVP)
// تم ربط الواجهة الأمامية بالخادم الخلفي (Vercel Python Backend)
// الأكواد مفروشة بالكامل بدون أي ضغط أو دمج
// ============================================================================
...
// ============================================================================
// نظام عداد المحاولات المجانية لرفع الصور والتلخيص (تعديل لـ 3 محاولات)
// ============================================================================
...
// ============================================================================
// نظام عداد المحاولات المجانية للمعلم (محاولتين فقط لتسجيل البصمة)
// ============================================================================

function checkTeacherAttempts() {
    
    let tAttempts = localStorage.getItem('teacher_attempts') || 0;
    
    tAttempts = parseInt(tAttempts);
...
function incrementTeacherAttempt() {
    ...
    tAttempts = parseInt(tAttempts) + 1;
...
// ============================================================================
// نظام عداد الـ 3 محاولات المجانية لـ (الشات والمحادثة الصوتية)
// ============================================================================
...
function incrementChatAttempt() {
    ...
    if (remaining > 0) {
        ...
        let msg = "تم استهلاك محاولة مجانية للتحدث. متبقي لك: ";
...
document.addEventListener(
    ...
    const subjectsDB = {
        primary_general: [ "اللغة العربية", "الرياضيات", "اللغة الإنجليزية (Connect)", "التربية الدينية الإسلامية", "التربية الدينية المسيحية", "القيم واحترام الآخر", "العلوم", "الدراسات الاجتماعية", "تكنولوجيا المعلومات والاتصالات (ICT)", "المهارات المهنية", "التربية الفنية", "التربية الموسيقية", "التربية البدنية", "التوكاتسو" ],
        primary_azhar: [ "القرآن الكريم", "التربية الإسلامية", "اللغة العربية", "الرياضيات", "اللغة الإنجليزية", "العلوم", "الدراسات الاجتماعية", "تكنولوجيا المعلومات والاتصالات", "المهارات المهنية" ],
        prep_general: [ "اللغة العربية", "الرياضيات (جبر وإحصاء)", "الرياضيات (هندسة)", "العلوم", "الدراسات الاجتماعية", "اللغة الإنجليزية", "التربية الدينية الإسلامية", "التربية الدينية المسيحية", "الحاسب الآلي وتكنولوجيا المعلومات", "التربية الفنية" ],
        prep_azhar: [ "القرآن الكريم", "الفقه", "أصول الدين (تفسير)", "أصول الدين (حديث)", "أصول الدين (توحيد)", "أصول الدين (سيرة نبوية)", "النحو", "الصرف", "المطالعة والنصوص", "الإنشاء", "الإملاء والخط", "الرياضيات (جبر وإحصاء)", "الرياضيات (هندسة)", "العلوم", "الدراسات الاجتماعية", "اللغة الإنجليزية", "الحاسب الآلي", "التربية الفنية" ],
        high_general_sci_biology: [ "اللغة العربية", "اللغة الإنجليزية", "اللغة الفرنسية", "اللغة الألمانية", "اللغة الإيطالية", "اللغة الإسبانية", "الفيزياء", "الكيمياء", "الأحياء", "الجيولوجيا وعلوم البيئة", "التربية الدينية", "التربية الوطنية", "الاقتصاد والإحصاء" ],
        high_general_sci_math: [ "اللغة العربية", "اللغة الإنجليزية", "اللغة الفرنسية", "اللغة الألمانية", "اللغة الإيطالية", "اللغة الإسبانية", "الفيزياء", "الكيمياء", "الرياضيات البحتة (تفاضل وتكامل)", "الرياضيات البحتة (جبر وهندسة فراغية)", "الرياضيات التطبيقية (استاتيكا)", "الرياضيات التطبيقية (ديناميكا)", "التربية الدينية", "التربية الوطنية", "الاقتصاد والإحصاء" ],
        high_general_lit: [ "اللغة العربية", "اللغة الإنجليزية", "اللغة الفرنسية", "اللغة الألمانية", "اللغة الإيطالية", "اللغة الإسبانية", "التاريخ", "الجغرافيا", "علم النفس والاجتماع", "الفلسفة والمنطق", "التربية الدينية", "التربية الوطنية", "الاقتصاد والإحصاء" ],
        high_azhar_sci: [ "القرآن الكريم", "الفقه", "التفسير", "الحديث", "التوحيد", "النحو", "الصرف", "البلاغة", "الأدب والنصوص", "اللغة الإنجليزية", "الفيزياء", "الكيمياء", "الأحياء", "الرياضيات (جبر وهندسة فراغية)", "الرياضيات (تفاضل وتكامل)", "الرياضيات (استاتيكا)", "الرياضيات (ديناميكا)" ],
        high_azhar_lit: [ "القرآن الكريم", "الفقه", "التفسير", "الحديث", "التوحيد", "النحو", "الصرف", "البلاغة", "الأدب والنصوص", "الإنشاء", "اللغة الإنجليزية", "اللغة الفرنسية", "التاريخ", "الجغرافيا", "المنطق" ],
        diploma_industrial: [ "اللغة العربية", "اللغة الإنجليزية", "الرياضيات", "الفيزياء العامة", "الحاسب الآلي", "التربية الدينية", "آلات كهربية", "رسم فني كهربائي", "تخطيط وإدارة إنتاج", "تحكم إلكتروني", "نظم إلكترونية", "دوائر منطقية", "شبكات كهربية", "أجهزة قياس", "اتصالات", "محركات سيارات", "تكنولوجيا اللحام", "صيانة وإصلاح", "رسم فني ميكانيكي", "تكنولوجيا الخراطة", "تكنولوجيا التبريد", "تكييف الهواء", "رسم فني تبريد وتكييف", "تكنولوجيا النجارة", "تكنولوجيا الملابس الجاهزة", "رسم فني معماري", "مقايسات عامة" ],
        diploma_commercial: [ "اللغة العربية", "اللغة الإنجليزية", "اللغة الأجنبية الثانية (فرنسي)", "الحاسب الآلي", "التربية الدينية", "إدارة أعمال", "إدارة مشتريات", "سكرتارية عربية", "سكرتارية إفرنجية", "اقتصاد", "إحصاء", "تسويق", "أعمال وساطة", "تأمينات أشخاص", "تأمينات هندسية", "رياضة مالية", "محاسبة مالية", "محاسبة شركات", "محاسبة ضرائب", "محاسبة حكومية", "قانون تجاري", "قانون عقوبات", "قانون مدني", "قانون مرافعات", "قانون عمل" ],
        diploma_agricultural: [ "اللغة العربية", "اللغة الإنجليزية", "الرياضيات", "الحاسب الآلي", "التربية الدينية", "الكيمياء الزراعية", "الفيزياء الزراعية", "الأحياء", "محاصيل الحقل", "تربية الحيوان والدواجن", "أمراض النبات", "حشرات اقتصادية", "الألبان", "الصناعات الزراعية", "الآفات", "استصلاح أراضي", "هندسة زراعية" ],
        diploma_tourism: [ "اللغة العربية", "اللغة الإنجليزية", "اللغة الأجنبية الثانية (فرنسي/ألماني/إيطالي)", "الحاسب الآلي", "التربية الدينية", "أصول فن الطهو", "خدمة المطاعم", "الإشراف الداخلي", "شركات السياحة", "اقتصاديات السياحة", "محاسبة فندقية", "أمن صناعي" ]
    };
    ...
    function startFilterProcess(subject) {
        ...
        let primaryBtn = createFilterButton('المرحلة الابتدائية', () => { selectFilterStage('primary'); });
        let prepBtn = createFilterButton('المرحلة الإعدادية', () => { selectFilterStage('prep'); });
        let highBtn = createFilterButton('المرحلة الثانوية', () => { selectFilterStage('high'); });
        let diplomaBtn = createFilterButton('الدبلومات الفنية', () => { selectFilterStage('diploma'); });
    ...
    function selectFilterStage(stage) {
        ...
        if (stage === 'primary' || stage === 'prep') {
            let genBtn = createFilterButton('تربية وتعليم (عام)', () => { selectFilterType('general'); });
            let azharBtn = createFilterButton('أزهري', () => { selectFilterType('azhar'); });
            ui.filterType.appendChild(genBtn);
            ui.filterType.appendChild(azharBtn);
        } else if (stage === 'high') {
            let sciBioBtn = createFilterButton('عام - علمي علوم', () => { selectFilterType('general_sci_biology'); });
            let sciMathBtn = createFilterButton('عام - علمي رياضة', () => { selectFilterType('general_sci_math'); });
            let litBtn = createFilterButton('عام - أدبي', () => { selectFilterType('general_lit'); });
            let azharSciBtn = createFilterButton('أزهري - علمي', () => { selectFilterType('azhar_sci'); });
            let azharLitBtn = createFilterButton('أزهري - أدبي', () => { selectFilterType('azhar_lit'); });
            ...
            let indBtn = createFilterButton('دبلوم صناعي', () => { selectFilterType('industrial'); });
            let comBtn = createFilterButton('دبلوم تجاري', () => { selectFilterType('commercial'); });
            let agrBtn = createFilterButton('دبلوم زراعي', () => { selectFilterType('agricultural'); });
            let tourBtn = createFilterButton('دبلوم سياحة', () => { selectFilterType('tourism'); });
    ...
    function selectFilterType(type) {
        ...
        for (let i = startGrade; i <= endGrade; i++) {
            ...
            let gBtn = createFilterButton(gradeText, () => { finishFiltering(i); });
    ...
    function updatePathDisplay() {
        ...
        try {
            ...
            let displayHtml = '<i class="fas fa-map-marker-alt"></i> مسار المادة المحدد: <br> ' + path;
    ...
    ui.mainStage.addEventListener('change', (event) => {
        ...
        if (val === 'primary') { 
            let primaryHtml = '<option value="">-- حدد نوع التعليم --</option><option value="general">تربية وتعليم (عام)</option><option value="azhar">أزهري</option>';
            ui.subStage.innerHTML = primaryHtml; 
            showElement(ui.subStageContainer); 
        } else if (val === 'prep') { 
            let prepHtml = '<option value="">-- حدد نوع التعليم --</option><option value="general">تربية وتعليم (عام)</option><option value="azhar">أزهري</option>';
            ui.subStage.innerHTML = prepHtml; 
            showElement(ui.subStageContainer); 
        } else if (val === 'high_general') { 
            let highGenHtml = '<option value="">-- حدد الشعبة --</option><option value="sci_biology">علمي علوم</option><option value="sci_math">علمي رياضة</option><option value="lit">أدبي</option>';
            ui.subStage.innerHTML = highGenHtml; 
            showElement(ui.subStageContainer); 
        } else if (val === 'high_azhar') { 
            let highAzharHtml = '<option value="">-- حدد الشعبة --</option><option value="sci">علمي</option><option value="lit">أدبي</option>';
            ui.subStage.innerHTML = highAzharHtml; 
            showElement(ui.subStageContainer); 
        } else if (val === 'diploma') { 
            let diplomaHtml = '<option value="">-- حدد التخصص --</option><option value="industrial">صناعي</option><option value="commercial">تجاري</option><option value="agricultural">زراعي</option><option value="tourism">سياحة وفنادق</option>';
    ...
    function populateYears(start, end, stageType) {
        ...
        for (let i = start; i <= end; i++) { 
            ...
            if (stageType === 'primary') {
                html += 'الصف ' + getOrdinal(i) + ' الابتدائي';
            } else if (stageType === 'prep') {
                html += 'الصف ' + getOrdinal(i) + ' الإعدادي';
            } else if (stageType === 'high') {
                html += 'الصف ' + getOrdinal(i) + ' الثانوي';
            } else if (stageType === 'diploma') {
                html += 'الصف ' + getOrdinal(i) + ' (دبلوم)';
            } else {
                html += 'الصف ' + getOrdinal(i);
            }
            html += '</option>';
        }
    ...
    lessonImageInput.addEventListener('change', (event) => {
        if (event.target.files.length > 0) {
            ...
            let textHtml = '<i class="fas fa-check-circle"></i> تم إرفاق الصورة بنجاح: ' + selectedLessonFile.name;
    ...
    document.getElementById('verify-teacher-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            let priceText = 'مبلغ الاشتراك المطلوب منك هذا الشهر هو: ' + requiredAmount + ' جنيه مصري';
    ...
    document.getElementById('receipt-upload').addEventListener('change', async (event) => {
        ...
        try {
            ...
            const expirationDate = new Date(paymentDate.getTime() + thirtyDaysMs); 
            ...
            btn.innerHTML = '<i class="fas fa-check"></i> تم استلام الإيصال وتفعيل الحساب!';
            btn.style.backgroundColor = "var(--success-color)";
            alert("تم التفعيل التلقائي بنجاح لمدة 30 يوماً.");
        } catch (error) {
            console.error("حدث خطأ:", error); 
            alert("حدث خطأ أثناء معالجة رفع الإيصال.");
            btn.innerHTML = '<i class="fas fa-upload"></i> رفع الإيصال وتفعيل الاشتراك مرة أخرى';
            btn.style.pointerEvents = "auto";
        }
    });

    // ============================================================================
    // 9. إرسال الطلب للسيرفر الخلفي (Vercel)
    // ============================================================================
    ...
    document.getElementById('process-btn').addEventListener('click', async () => {
        ...
        btnText.innerHTML = '<i class="fas fa-spinner fa-spin"></i> جاري قراءة وتلخيص الصورة المرفوعة...';
        ...
        try {
            ...
            if (needNewUploadAndAPI) {
                btnText.innerHTML = '<i class="fas fa-cloud-upload-alt"></i> جاري معالجة الصورة عبر سيرفر فيرسل...';
                ...
                // إرسال الطلب للسيرفر الخلفي اللي برمجناه بالبايثون (Vercel)
                const serverPayload = {
                    image_base64: imageBase64,
                    subject: subject,
                    year: yearText,
                    mime_type: selectedLessonFile.type
                };
    ...
    function showOutput(serverData, subjectName) {
        ...
        let metaHtml = '<i class="fas fa-cloud-download-alt"></i> تاريخ الإنشاء: ' + creationDateObj.toLocaleDateString('ar-EG') + ' | المادة: ' + serverData.subjectTitle;
    ...
    function generateRealPDF(serverData) {
        ...
        let footerText = 'تاريخ الإنشاء: ' + pdfCreationDate + ' | عدد الأسئلة المستخرجة: ' + questionCount;
        let footerElement = document.querySelector('#pdf-template > div > div:last-child');
        
        if(footerElement) {
            footerElement.innerHTML = footerText + '<br>تم التوليد بواسطة منصة إمبراطورية المعرفة للذكاء الاصطناعي © 2026';
        }
    ...
    if (teacherRecordBtn) {
        teacherRecordBtn.addEventListener('click', () => {
            if (!currentTeacherId) {
                if (!checkTeacherAttempts()) return;
            }
            const subject = ui.subjectSelect.value;
            let yearText = "";
            if (ui.yearStage.options[ui.yearStage.selectedIndex]) {
    ...
    async function sendMessageToBot(messageText) {
        ...
        if (ui.subjectSelect.value) subjectVal = ui.subjectSelect.value;
        ...
        try {
            // إرسال الطلب للسيرفر الخلفي (Vercel)
            ...
            if (!response.ok) throw new Error("فشل الاتصال بخوادم فيرسل في الشات");
