...
// ============================================================================
// 4. الداش بورد المطور (القائمة الجانبية تختفي بالنقر خارجها في الموبايل،
//    وتترك صفحة التحكم والبيانات والجداول مفتوحة وكاملة أمام المسؤول)
// ============================================================================
async function loadAndShowDashboard() {
    ...
    container.innerHTML = `
        <div id="dash-main-wrapper" style="width: 100%; height: 100%; display: flex; background: #f8fafc; position: relative;">
            ...
            <!-- المنطقة الرئيسية اليسرى (تبقى مفتوحة وثابتة أمامك بكامل الشاشة على الموبايل) -->
            <div style="flex: 1; display: flex; flex-direction: column; overflow-y: auto; background: #f8fafc; width: 100%;">
                <!-- الشريط العلوي (يحتوي على زر القائمة للموبايل + زر إغلاق الداشبورد) -->
    ...
    // في الموبايل: النقر في أي مكان خارج القائمة الجانبية يخفي القائمة فقط ولا يغلق لوحة التحكم
    container.addEventListener('click', (e) => {
        if (window.innerWidth <= 768) {
            ...
            if (sidebar && !sidebar.contains(e.target) && (!toggleBtn || !toggleBtn.contains(e.target))) {
                sidebar.style.right = '-320px'; // إخفاء القائمة الجانبية وترك الشاشة للجداول والبيانات
            }
        }
    });

    // زر إظهار/إخفاء القائمة الجانبية في الموبايل
    const toggleBtn = document.getElementById('dash-sidebar-toggle-btn');
    if (toggleBtn) {
    ...
    // أزرار الإغلاق الصريح للوحة التحكم (الزر الأحمر في الشريط أو في القائمة)
...
window.switchDashTab = function(tabName) {
    ...
    // إخفاء القائمة الجانبية في الموبايل تلقائياً بعد اختيار التبويب لتوسيع الشاشة
    if (window.innerWidth <= 768) {
        const sidebar = document.getElementById('dash-sidebar-panel');
