...
document.addEventListener(
    ...
    // ============================================================================
    // 9. التحقق، التطهير الأمني (Sanitization)، والاتصال بالخادم وجلب بصمة المعلم
    // ============================================================================
    ...
    document.getElementById('process-btn').addEventListener(
        ...
        try {
            ...
            if (needNewUploadAndAPI) {
                ...
                uploadingText += ' جاري معالجة الصورة عبر الخادم الآمن...';
                ...
                let url = 'https://mahmodnagep.pythonanywhere.com/api/analyze_lesson';
                ...
                url += encodeURIComponent(yearText);
                
                url += '&image_url=';
                
                url += encodeURIComponent(newImageUrl);
                
                const response = await fetch(url);
                
                if (!response.ok) {
                    
                    throw new Error("فشل الاتصال بالخادم السحابي المحصن");
            ...
            alert("حدث خطأ في الشبكة أو تم حظر الطلب من جدار الحماية الخاص بالخادم.");
