...
document.addEventListener('DOMContentLoaded', () => {
            ...
            try {
                ...
                if (doc.exists) {
                    ...
                    if (teacherData.registeredDeviceFingerprint && teacherData.registeredDeviceFingerprint !== deviceFingerprint) {
                        alert("عفواً، لا يمكنك تسجيل الدخول. هذا الحساب مرتبط بمكان آخر لمنع التلاعب.");
    ...
    function generateRealPDF(serverData) {
        ...
        // التعديل هنا: تأخير عملية التصوير نص ثانية عشان المتصفح يلحق يعرض المحتوى بدل ما يصوره أبيض
        setTimeout(() => {
