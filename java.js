...
// النسخة الخاصة بالاتصال بسيرفر Vercel (Backend Python) - مفروشة بالكامل
// ============================================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================================================
    // 9. إرسال الطلب للسيرفر الخلفي (Vercel Backend)
    // ============================================================================
    ...
    if (processBtn) {
        processBtn.addEventListener('click', async () => {
            ...
            btnText.innerHTML = '<i class="fas fa-spinner fa-spin"></i> جاري إرسال الصورة للسيرفر الخلفي...';
            ...
            try {
                ...
                if (needNewUploadAndAPI) {
                    ...
                    // ==========================================
                    // هنا بيتم الاتصال بسيرفر البايثون (Backend)
                    // ==========================================
                    const serverPayload = {
    ...
    async function sendMessageToBot(messageText) {
        ...
        try {
            // ==========================================
            // الشات هنا بيكلم السيرفر الخلفي (Backend)
            // ==========================================
