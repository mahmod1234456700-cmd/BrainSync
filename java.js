...
// قائمة أرقام الإدارة المعتمدة فقط (اللي يقدروا يفتحوا الداش بورد ويفعلوا الاشتراكات يدوي)
const AUTHORIZED_ADMIN_PHONES = [
    "01067479440",
    "01000000000" // تقدر تضيف أي رقم مسؤول هنا
];
...
// ============================================================================
// 2. منطق تسجيل الدخول وإرفاق الإيصال (بدون تفعيل تلقائي)
// ============================================================================
...
async function handleUserLogin() {
    ...
    try {
        ...
        if (doc.exists) {
            ...
            // لو حسابه شغال VIP أو هو أدمن معتمد، يدخل فوراً
...
// التفعيل اليدوي: يتم الرفع وإشعار المستخدم بالانتظار دون تغيير الحالة تلقائياً إلى VIP_Active
async function handleReceiptUpload(event) {
    ...
    try {
        ...
        // جعل الحالة "Pending_Review" وعدم تفعيل الـ VIP تلقائياً
        ...
        // عرض رسالة الانتظار المحددة من الطالب
...
// ============================================================================
// 4. الداش بورد الكامل والمطابق لصور تصميم Peak Skill Academy
//    مع ميزة التفعيل اليدوي وكتابة المدة بايدك (شهر، سنة، 6 شهور...)
// ============================================================================
async function loadAndShowDashboard() {
    ...
    container.innerHTML = `
        <!-- الشريط الجانبي الأيمن الكحلي (Navy Blue Sidebar - Peak Skill Academy Style) -->
        ...
        <div style="flex: 1; display: flex; flex-direction: column; overflow-y: auto; background: #f8fafc;">
            ...
            <div style="background: #ffffff; padding: 16px 30px; border-bottom: 1px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h2 style="margin: 0; color: #0f172a; font-size: 1.4rem; font-weight: bold;">إدارة الحسابات وطلبات تفعيل VIP اليدوية</h2>
                    <span style="color: #64748b; font-size: 0.85rem;">مراجعة إيصالات التحويل وتحديد مدة الاشتراك يدوياً</span>
                </div>
            ...
            <div style="padding: 25px 30px;">
                ...
                <!-- 3 كروت إحصائيات علوية (مثل الصورة المرفقة 10 of 12) -->
    ...
    try {
        ...
        snapshot.forEach(doc => {
            ...
            let receiptHtml = data.lastPaymentReceipt 
                ...
                : `<span style="color: #94a3b8;">لا يوجد إيصال</span>`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // تشغيل شاشة تسجيل الدخول تلقائياً أول ما الموقع يفتح
    createAuthScreen();
    showAuthScreen();
    ...
    // ============================================================================
    // 7. إرسال الطلب للسيرفر والتلخيص (مع الشروط: نفس اللغة، معطيات الرياضيات،
