...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================================================
    // 7. إرسال الطلب للسيرفر والتلخيص (بدون كاش لضمان التوليد الفعلي لـ 60-90 سؤال)
    // ============================================================================
    const processBtn = document.getElementById('process-btn');
    ...
    // ============================================================================
    // 8. عرض المخرجات وتوليد ملف PDF شامل (مع إظهار علامة الصح ✓ في الإجابة)
    // ============================================================================
        ...
        serverData.qa_data.forEach((item, index) => {
            ...
            if (item.options && Array.isArray(item.options) && item.options.length > 0) {
                ...
                item.options.forEach((opt) => {
                    ...
                    // وضع علامة صح (✓) بجانب الاختيار لو هو ده الإجابة الصحيحة (في وضع غير الامتحان)
            ...
            if (!isExamMode) {
                let answerPrefix = (item.type === "TF") ? "<strong>(✓ الحكم على العبارة): </strong>" : "<strong>(✓ الإجابة النموذجية): </strong>";
                qaHtml += '<p style="margin: 10px 0 0 0; line-height: 1.8; font-size: 13px; color: #059669;">' + answerPrefix + '<br>' + item.a.replace(/\n/g, '<br>') + '</p>';
