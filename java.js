...
// قائمة أرقام الإدارة المعتمدة (تم إضافة رقمك 01026336159 لفرز المسؤولين وإظهار الداش بورد)
...
// ============================================================================
// 2. منطق تسجيل الدخول وإرفاق الإيصال (مع الفرز الفوري للمسؤولين)
// ============================================================================
...
async function handleUserLogin() {
    ...
    try {
        ...
        // فرز الأرقام: فحص هل الرقم من ضمن المسؤولين
        ...
        if (doc.exists) {
            ...
            // لو هو مسؤول معتمد أو حسابه شغال VIP بيدخل فوراً
...
// ============================================================================
// 3. رسائل النجاح، وبناء واجهة المستخدم بعد الدخول (مع إظهار الداش بورد للمسؤول)
// ============================================================================
    ...
    try {
        ...
        snapshot.forEach(doc => {
            ...
            if (status === "VIP_Active") {
                ...
                statusBadge = `<span style="background: #fee2e2; color: #991b1b; padding: 6px 14px; border-radius: 20px; font-weight: bold; font-size: 0.85rem;">مجاني</span>`;
            }
...
// دالة التفعيل اليدوي VIP بواسطة المدة المكتوبة يدوياً في الحقل
...
window.deactivateUserVIP = async function(phone) {
    ...
    try {
        ...
        showToast(`تم إلغاء تفعيل الحساب: ${phone}`, "#ef4444");
        loadDashboardTableData();
    } catch (e) {
        alert("خطأ: " + e.message);
    }
