...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateRealPDF(serverData) {
        ...
        // ========================================================
        // الحل الجذري النهائي للموبايل (مشكلة الشاشة البيضاء)
        // ========================================================
        const originalScrollY = window.scrollY || document.documentElement.scrollTop;
        window.scrollTo(0, 0); // نطلع لأول الصفحة عشان مكتبة html2canvas تصور من الصفر
        ...
        setTimeout(() => {
            html2pdf().set(opt).from(elementToPrint).save().then(() => {
                ...
                window.scrollTo(0, originalScrollY); // نرجع المستخدم مكانه
